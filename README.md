...
Генеративный ИИ ChatGPT использовался того чтобы более подробно описать принцип работы некоторых функций в данном проекте специально для README.md файла. Так же ИИ подсказывал, в каких местах находятся ошибки в коде и как их можно исправить.
